        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="view/sobre.php"> <img
                    src="https://cdn-icons-png.flaticon.com/512/3817/3817173.png" width="30px"> </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="view/contatos.php"> <img
                    src="https://cdn-icons-png.flaticon.com/512/3095/3095583.png" width="30px"> </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="view/login.php"> <img src="imagens/login.png" width="30px"> </a>
              </li>
              <!--Aba de pesquisa -->
            </ul>
        ...
        <section class="">
          <nav>
            <form action="">
              ...
              <div class="col-auto">
              <a class="nav-link" href="view/ouvidoria.php"> 
